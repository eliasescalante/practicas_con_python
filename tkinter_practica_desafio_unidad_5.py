...
# Agrego el label y el entry para "ruta"
ruta = Label(root, text="Ruta")
ruta.grid(row=3, column=0, sticky="e", padx=1, pady=10)
entry_ruta = Entry(root, textvariable=ruta_var, width=25)
entry_ruta.grid(row=3, column=3, sticky="e", padx=5, pady=10)
...
def alta():
    ...
    print(f"titulo: {titulo_var.get()}, ruta: {ruta_var.get()}  , descripcion:{descripcion_var.get()}")
